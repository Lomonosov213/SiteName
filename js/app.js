...
/*
$(".news-box__left-list .left-list__item").click(function () {

   // alert('hi');
   $(this).parents(".left-list__special-wrapp").toggleClass("active-item"); //добавляем класс текущей (нажатой)
})
*/

$(".news-box__left-list .left-list__special-wrapp ").click(function () {
   $('.news-box__left-list .left-list__special-wrapp ').removeClass('active-item');
...
$(".calculator-block__icons .calculator-block__icon-wrapp ").click(function () {
   $('.calculator-block__icons .calculator-block__icon-wrapp ').removeClass('active-icon');
...
if (sliders) {
	...
	$(".kripto-slider .kripto-slider__wrapp ").click(function () {
		$('.kripto-slider .kripto-slider__wrapp ').removeClass('active-slide');
		$(this).addClass('active-slide');
	});


	/*
		$(".kripto-slider .kripto-slider__item").click(function () {
	
			$(this).parents(".kripto-slider__wrapp").toggleClass("active-slide"); //добавляем класс текущей (нажатой)
		})
		*/
...
let slider_about = new Swiper('.right-slider__body', {
	...
	// Dotts
	pagination: {
		el: '.right-slider__dots',
		clickable: true,
	},
	// Arrows
	navigation: {
		nextEl: '.kripto-slider__arrow_next',
		prevEl: '.kripto-slider__arrow_prev',
	},
	/*
	breakpoints: {
		320: {
...
let kripto = new Swiper('.kripto-slider__body', {
	observer: true,
	observeParents: true,
	slidesPerView: 4,
	spaceBetween: 30,
...
let reviews = new Swiper('.reviews-slider__body', {
	observer: true,
	observeParents: true,
	slidesPerView: 3,
	spaceBetween: 30,
	...
	// Dotts
	pagination: {
		el: '.right-slider__dots3',
		clickable: true,
	},
	// Arrows
	navigation: {
		nextEl: '.kripto-slider__arrow_next3',
		prevEl: '.kripto-slider__arrow_prev3',
	},
...
let news = new Swiper('.news-slider__body', {
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	spaceBetween: 30,
	...
	// Dotts
	pagination: {
		el: '.right-slider__dots4',
		clickable: true,
	},
	// Arrows

	navigation: {
		nextEl: '.kripto-slider__arrow_next4',
		prevEl: '.kripto-slider__arrow_prev4',
	},
